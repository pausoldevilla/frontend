...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="py-10 md:py-24 px-6 max-w-[1400px] mx-auto">
      ...
      <div className="py-10 md:py-24 px-6 max-w-[1400px] mx-auto border-t border-gray-100">
      ...
      <div id="categories" className="py-10 md:py-24 px-6 max-w-[1400px] mx-auto border-t border-gray-100">
